# Generated by Django 4.0.6 on 2023-03-15 12:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('newappemail', models.CharField(blank=True, default='-', max_length=122)),
                ('newappphone', models.CharField(max_length=12)),
                ('newappaddress', models.CharField(max_length=122)),
                ('newappdepart', models.CharField(blank=True, max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('buildings', models.ManyToManyField(blank=True, to='home.addbuilding')),
                ('profile', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='home.profile')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('examshift', models.CharField(blank=True, max_length=122, null=True)),
